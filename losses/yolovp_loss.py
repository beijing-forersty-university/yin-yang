...
class YolopLoss(nn.Module):
    def __init__(self, num_classes=80, num_layers=3, num_anchors=3, stride=[8., 16., 32.],
                 anchors=[[3, 9, 5, 11, 4, 20], [7, 18, 6, 39, 12, 31], [19, 50, 38, 81, 68, 157]], device='cuda:0'):
        ...
        self.lane_line_segmentation_iou_criterion = nn.BCEWithLogitsLoss(
            pos_weight=torch.tensor([1.0], device=self.device))
